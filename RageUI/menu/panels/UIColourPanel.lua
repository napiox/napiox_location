...
function RageUI.ColourPanel(Title, Colours, MinimumIndex, CurrentIndex, Action, Index, Style)
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (CurrentMenu.Index == Index) then
            ...
            RenderRectangle(CurrentMenu.X, CurrentMenu.Y + 5 + Colour.Background.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, Colour.Background.Width + CurrentMenu.WidthOffset, Colour.Background.Height, 20, 24, 28, 255)
